/*
PatientInformationV5: class to represent an instance of a patient (including their relevant,
...
public:
	...
	*/
	PatientInformationV5(string id, string sequenceNum, string name, string date, string gender, string phys)
	{
		setPatientID(id);
