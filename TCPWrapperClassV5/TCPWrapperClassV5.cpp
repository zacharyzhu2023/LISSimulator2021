...
#include "TCPWrapperClassV5.h"

using namespace System::Collections::Generic;

/**
<summary>
Wrapper method to initialize instance of TCPConnectionV5 from a C# application.
</summary>
...
<returns></returns>
*/
TCPWrapperClassV5::TCPWrapperClassV5(bool isServer, double sendDelay, String^ msg1, String^ msg2)
	: ManagedObject(new TCPConnectionV5(isServer, sendDelay, toCPPString(msg1), toCPPString(msg2)))
{
...
<returns></returns>
*/
void TCPWrapperClassV5::printTime()
{
	m_Instance->printTime();
}
...
<returns></returns>
*/
void TCPWrapperClassV5::printChar(char c)
{
	TCPConnectionV5::printChar(c);
}
...
<returns></returns>
*/
void TCPWrapperClassV5::printMessage(String^ message)
{
	TCPConnectionV5::printMessage(toCPPString(message));
}
...
<returns></returns>
*/
void TCPWrapperClassV5::listen(String^ ipAddress, int port)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::close(int handle)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::addSampleOrder(String^ sampleID, PatientInformationV5 patient, vector<AssayV5> assays)
{
	/*
...
<returns></returns>
*/
void TCPWrapperClassV5::deleteSampleOrder(String^ sampleID)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::setMaximumDatabaseSize(int size)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::setHeaderFrom(int handle, String^ headerFrom)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::setHeaderTo(int handle, String^ headerTo)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::setHeaders(int handle, String^ toHeader, String^ fromHeader)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::setDelimiters(int handle, String^ fieldD, String^ componentD, String^ repeatD, String^ escapeD)
{
...
<returns></returns>
*/
void TCPWrapperClassV5::setAutoOrder(int handle, vector<AssayV5> aVector)
{
	/*
	Design Note: aVector should be a list of AssayV5 in reality to be instantiated from C#.
...
<returns></returns>
*/
void TCPWrapperClassV5::setLineBids(int handle, int priority, int numLineBids, int msTimeout)
{
