/*
CSharpServerApp: C# application to test the CLI wrapper class and running TCPConnection from 
...
namespace CSharpServerApp
{
    class CSharpServer
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write("Enter any number to exit: ");
            Console.ReadLine();
        }
    }
}
