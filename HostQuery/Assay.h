/*
Assay: class to represent an instance of an assay (including their relevant,
...
public:
	...
	*/
	Assay(string id, string sequenceNum, string assayName, string analyteName, string num,
